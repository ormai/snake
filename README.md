The [snake](https://en.wikipedia.org/wiki/Snake_(1998_video_game)) game written in C for the terminal. The project is small[^1] C and doesn't rely on external dependencies.
